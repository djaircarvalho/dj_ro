...
class SprintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post sprints_url, params: { sprint: { closing_date: @sprint.closing_date, name: @sprint.name, opening_date: @sprint.opening_date, project_id: @sprint.project_id } }
    end
  ...
  test "should update sprint" do
    patch sprint_url(@sprint), params: { sprint: { closing_date: @sprint.closing_date, name: @sprint.name, opening_date: @sprint.opening_date, project_id: @sprint.project_id } }
