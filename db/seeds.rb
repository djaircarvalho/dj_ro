...
Task.create!([
  ...
  {title: "Adicionar campo admin em user", description: "Adicionar o campo admin do tipo boolean no modelo de user para indicar se o mesmo eh administrador.", estimated_time: 20, time_spent: 40, sprint: s2, status: "homologating", started_in: nil, finished_in: "2016-08-12 14:12:54", user: u },
  ...
  {title: "configurar autotização de  projetos", description: "configurar autotização de usuario para que apenas admin possa criar e gerenciar projetos", estimated_time: 40, time_spent: 30, sprint: s2, status: "finished", started_in: nil, finished_in: "2016-08-14 14:12:54", user: u1 },
  {title: "configurar autotização de  sprints", description: "configurar autotização de usuario para que apenas admin possa criar e gerenciar sprints.", estimated_time: 30, time_spent: 50, sprint: s2, status: "stoped", started_in: nil, finished_in: "2016-08-14 14:12:54", user: u },
  ...
  {title: "Adicionar status em task", description: "Adicionar enum para representar a situação da tarefa.", estimated_time: 10, time_spent: 15, sprint: s2, status: "finished", started_in: nil, finished_in: "2016-09-25 14:12:33", user: u }
])
